// 4. Show not yet finalised projects
...
public class NotYetFinalised {
    
    public static void NotYetFinalised(Connection connection) throws SQLException {
        System.out.println("Finalised Projects:\n");

        // Execute the query to retrieve not yet finalised projects
        String query = "SELECT * FROM Project WHERE CompletionDate IS NULL";
        PreparedStatement preparedStatement = connection.prepareStatement(query);
        ResultSet resultSet = preparedStatement.executeQuery();

        // Display the not yet finalised projects
